...
# PATHS
# ============================================================
Q_DIR = < Path / To /  Qbar_SS_blocks >
J_DIR = < Path / To / Modified_J_m_blocks >
L_DIR = < Path / To / L_tensor_blocks >

C_PATH = < Path / To / Cprime_Gamma_all.pkl >
G_PATH = < Path / To / Modified_G_all.pkl >
S_PATH = < Path / To / S_SS_tables.pkl >

F_PATH =  < Path / To / f_integrals.npz >

OUTDIR = < Path / To / Projected_SS_Convergence >
